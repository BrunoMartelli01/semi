...
_PREDEFINED_SPLITS_PIC = {
    "pic_person_train": ("pic/image/train_images", "pic/annotations/train_person.json"),
...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "hiertext_train_1_unlabel": ("hiertext/train_images", "hiertext/train_96voc_1_unlabeled.json"),

    # 2 % split
    "hiertext_train_2_label":   ("hiertext/train_images", "hiertext/train_96voc_2_labeled.json"),
    "hiertext_train_2_unlabel": ("hiertext/train_images", "hiertext/train_96voc_2_unlabeled.json"),

    # 5 % split
    "hiertext_train_5_label":   ("hiertext/train_images", "hiertext/train_96voc_5_labeled.json"),
    "hiertext_train_5_unlabel": ("hiertext/train_images", "hiertext/train_96voc_5_unlabeled.json"),

    # 10 % split (96-voc variant)
    "hiertext_train_10_96voc_label":   ("hiertext/train_images", "hiertext/train_96voc_10_labeled.json"),
    "hiertext_train_10_96voc_unlabel": ("hiertext/train_images", "hiertext/train_96voc_10_unlabeled.json"),

    # ------------------------------------------------------------------ #
    # Other datasets — 37-voc
    # ------------------------------------------------------------------ #
    ...
    # semi-supervised settings — TotalText 37-voc
    ...
    # ------------------------------------------------------------------ #
    # 96-voc variants of common datasets
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # Evaluation (annotations may be empty — only images are loaded)
    # ------------------------------------------------------------------ #
    "totaltext_test": ("totaltext/test_images", "totaltext/test_images.json"),
    "ic15_test":      ("ic15/test_images", "ic15/test_images.json"),
    "ctw1500_test":   ("ctw1500/test_images", "ctw1500/test_images.json"),
}
...
# ---------------------------------------------------------------------------
# CLI argument parsing (needed when this module is imported by demo/demo.py)
# ---------------------------------------------------------------------------
