...
_PREDEFINED_SPLITS_TEXT = {
    ...
    # "inversetext_test": ("inversetext/test_images", "inversetext/test_images.json"),
    # "rects_test": ("ReCTS/ReCTS_test_images", "ReCTS/rects_test.json"),
    # "textocr_test": ("textocr/test_images", "textocr/test_images.json"),°
}
